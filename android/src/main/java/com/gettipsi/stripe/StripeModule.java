...
public class StripeModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void paymentRequestWithFpx(final Promise promise) {
    ...
    private void attachFPXPaymentResultActivityListener(final Promise promise) {
        ActivityEventListener ael = new BaseActivityEventListener() {
            ...
            public void onActivityResult(Activity a, int requestCode, int resultCode, Intent data) {
                ...
                Log.d(getName(), "onTextChanged: cardNumber = " + requestCode);
                ...
                if (result instanceof AddPaymentMethodActivityStarter.Result.Success) {
                    ...
                    PaymentMethod paymentMethod = successResult.getPaymentMethod();
                    ...
                    WritableMap fpxResult = Arguments.createMap();
